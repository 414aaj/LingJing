...
LingJing 平台的靶场资源丰富多样，涵盖开源靶场靶机以及后续原创平台的原创靶机。（正在尝试策划一种创新的打靶模式，以 **2D RTS 游戏风格实现互联网侧和近源渗透实景模拟**，为用户带来全新的训练体验（若感兴趣，请予以支持，为创作提供动力））。这些靶场资源覆盖广泛的安全技术方向，满足教育教学、专业培训与实战演练的需求，**包括但不仅限于**：
